...
@WebServlet("/StaffCollege")
public class StaffCollege extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement stmt = con.prepareStatement("INSERT INTO staff (id, name, enrollment, department, course, email,  mobile) VALUES (?, ?, ?, ?, ?, ?, ?)");
            stmt.setString(1, id);
            ...
            document.add(new Paragraph("Staff Name: " + name));
