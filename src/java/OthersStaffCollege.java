...
@WebServlet("/OthersStaffCollege")
public class OthersStaffCollege extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement stmt = con.prepareStatement("INSERT INTO otherstaff (id, name, enrollment, department, course, email,  mobile) VALUES (?, ?, ?, ?, ?, ?, ?)");
            stmt.setString(1, id);
            ...
            document.open();
            document.add(new Paragraph("Others Staff  Registration Details"));
            document.add(new Paragraph("ID: " + id));
            document.add(new Paragraph("Others Staff Name: " + name));
